...
sudo echo "10.30.3.30 broker1" | sudo tee -a /etc/hosts
sudo echo "10.30.3.20 vkc-br2" | sudo tee -a /etc/hosts
sudo echo "10.30.3.20 broker2" | sudo tee -a /etc/hosts
sudo echo "10.30.3.10 vkc-br3" | sudo tee -a /etc/hosts
sudo echo "10.30.3.10 broker3" | sudo tee -a /etc/hosts
sudo echo "10.30.3.40 vkc-br4" | sudo tee -a /etc/hosts
sudo echo "10.30.3.10 broker4" | sudo tee -a /etc/hosts
sudo echo "10.30.3.50 vkc-br5" | sudo tee -a /etc/hosts
sudo echo "10.30.3.50 broker5" | sudo tee -a /etc/hosts
