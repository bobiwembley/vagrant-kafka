#!/bin/bash
###Bootstrap jmx and prometheus to monitor 

# cd  $KAFKA_HOME/libs/
# wget https://repo1.maven.org/maven2/io/prometheus/jmx/jmx_prometheus_javaagent/0.13.0/jmx_prometheus_javaagent-0.13.0.jar
# echo "export KAFKA_OPTS=' -javaagent:$KAFKA_HOME/libs/jmx_prometheus_javaagent-0.13.0.jar=7075:$KAFKA_HOME/config/sample_jmx_exporter.yml'" >> $KAFKA_HOME/bin/kafka-server-start.sh
